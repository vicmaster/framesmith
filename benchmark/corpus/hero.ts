// Phase 6b benchmark corpus: the README hero (dashboard mock).
// Same scene graph that produces docs/hero.png — see scripts/build-hero.ts,
// which imports from this module so there's a single source of truth.
...
export const heroRoot: SceneNode = {
